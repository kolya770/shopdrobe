...
<body>
    ...
    <div class="modal thanks-page" id="thanks" style="display: none">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 poll-text">
                    ...
                    <div class="poll-header">
                        <h3>Let friends solve your
                            everyday fitting room dilemmas</h3>
                    </div>
                    <div class="poll-header">
                        <h3>With Shopdrobe you can make the right choice quickly and easily</h3>
                    </div>
                </div>
                <div class="col-xs-12 iphone">
                    <div class="size-iphone-block center-block">
                        <div class="before_after_slider" touch-action="none">
                            <div class="color">
                                <img src="img/iphone-poll1.png" alt="" />
                            </div>
                            <div class="black_white">
                                <img src="img/iphone-poll2.png" alt="black_white" />
                            </div>
                        </div>

                    <img class="iphone-phone" src="img/iphone-poll.png">
                        </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 look-text">
                    ...
                    <div class="look-header">
                        <h3>Share your looks and set new fashion trends</h3>
                    </div>
                </div>
                <div class="col-xs-12 iphone">
